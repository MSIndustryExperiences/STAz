...
# create_scale_set "$PREFIX-front-end-ss"
...
echo "OPENING PORTS"
open_inbound_ports "$PREFIX-01" 80 8009 8005 2181 8983 7983 2888 3888 # FRONT END - zk, Solr, Tomcat
# open_inbound_ports "$PREFIX-02-vm-nsg" 80 8009 8005 2181 8983 7983 2888 3888 # FRONT END - zk, Solr, Tomcat
# open_inbound_ports "$PREFIX-03-vm-nsg" 80 8009 8005 2181 8983 7983 2888 3888 # FRONT END - zk, Solr, Tomcat
# open_inbound_ports "$PREFIX-04-vm-nsg" 1802 1801 1099 2099 8161 # ActiveMQ
# open_inbound_ports "$PREFIX-05-vm-nsg" 8983 7983 27017 # Solr, MongoDB
# open_inbound_ports "$PREFIX-06-vm-nsg" 8983 7983 8080 8009 8005 # seed, Solr, Tomcat
